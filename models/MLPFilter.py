...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        print(self.device)
        self.hidden_dim_of_mlp = 256
        self.hidden_layers_of_mlp = 2
        
        self.mlp_layer = MLP(self.enc_dim, self.dec_dim, 
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # Use MLP layer for prediction
        predictions_flat = self.mlp_layer(x_enc)  # Pass through MLP
